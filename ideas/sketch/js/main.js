...
$(function () {
    ...
    $.each(userData, function (i, f) {
        ...
        $.each(f.rating, function (i, f) {
            ...
            $("#card_container").append('<div class="card-content white-text"><div class="row"><div class="col s3" style="margin-top: 5px;"><i class="medium material-icons emoji brand-logo">'+ rating1 +'</i></div><div class="col s6"><h4 class="grey-text text-darken-4 title center-align card-title truncate">'+temp_data.title+'</h4></div><div class="col s3" style="margin-top: 10px;"><a href="#modal" id="modal_btn"class="secondary-content  btn-floating waves-effect waves-light modal-trigger"><i class="small material-icons">edit</i></a></div></div><div class="row"><div class="col s5"></div><div class="col s2"><img src="images/img_avatar.jpg" alt="" class="circle responsive-img"></div><div class="col s5"></div></div><div class="row valign-wrapper"><div class="col s2"><img src="images/img_avatar.jpg" alt="" class="circle responsive-img"></div><div class="col s8 center-align"><img src="images/img_avatar.jpg" alt="" class="circle responsive-img"></div><div class="col s2"><img src="images/img_avatar.jpg" alt="" class="circle responsive-img"></div></div><div class="row"><div class="col s5"></div><div class="col s2"><img src="images/img_avatar.jpg" alt="" class="circle responsive-img"></div><div class="col s5"></div></div><div class="row"><div class="card-tabs"><ul class="tabs tabs-fixed-width"><li class="tab"><a href="#memorable_div" class="blue white-text">Memorable</a></li><li class="tab"><a href="#comment_div" class="blue white-text">Comment</a></li></ul></div><div class="card-content black-text"><div id="memorable_div"><ul class="collection" id="memorable_ul"></ul></div><div id="comment_div"><ul class="collection" id="comment_ul"></ul><div class="input-field"><i class="material-icons prefix send_comment">mode_edit</i><textarea id="comment_txt" class="materialize-textarea"></textarea></div></div></div></div></div>')
