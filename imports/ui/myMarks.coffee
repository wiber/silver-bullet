# lists bookmarks by date
# expands to show lists
# title has number count / later this week

filenName = 'myMarks.coffee'
...
stepsContainer = require('../api/stepsContainer.coffee').selectedContainer
